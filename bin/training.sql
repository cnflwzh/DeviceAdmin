...
CREATE TABLE `busi_device_info`  (
  ...
  `device_purchase_date` datetime NULL DEFAULT NULL COMMENT '采购时间',
  `deice_use_limit` datetime NULL DEFAULT NULL COMMENT '使用年限',
...
CREATE TABLE `busi_userinfo`  (
  ...
  `phone_number` varchar(11) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '电话号',
